...
/**
 * 
* @ClassName: DefEmoticons 
* @Description: TODO
* @author lvxin
* @date May 26, 2015 10:18:13 AM
 */
public class DefEmoticons {
     ...
     * @return
     */
    public static EmoticonBean getEmoticonBean(String content) {
        EmoticonBean EmoticonBean = null;
        for (EmoticonBean bean : emotions) {
            if (bean.getContent().trim().equals(content.trim())) {
                EmoticonBean = bean;
                break;
            }
        }
    ...
    public static final ArrayList<EmoticonBean> emotions = new ArrayList<EmoticonBean>() {
        private static final long serialVersionUID = Long.MAX_VALUE - 10000;
